...
namespace GamepadCursorMode::UI::Style
{
	...
	// rather than independently-styled pages.
	//
	...
	// and any suggestion/autocomplete lists let the page behind bleed
	// through and become genuinely hard to read.
	...
	// a real readability problem, especially for explanatory lines that
	// sit under most controls.
