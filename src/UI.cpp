...
namespace GamepadCursorMode::UI
{
    namespace
    {
        ...
        void __stdcall Render()
        {
            ...
            ImGui::Spacing();
            changed |= ImGui::Checkbox("Enable Gamepad Cursor Mode", &settings.enabled);
            ...
            UI::Style::Hint("D-pad Right is the default because Complete Controller Setup leaves it available in its standard layout.");
    ...
    void Register()
    {
        ...
        SKSEMenuFramework::SetSection("Gamepad Cursor Mode");
